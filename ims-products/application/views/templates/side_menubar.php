<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview" id="mainProductNav">
          ...
          <ul class="treeview-menu">
            <?php if (in_array('createProduct', $user_permission)) : ?>
              <li id="addProductNav"><a href="<?php echo base_url('Controller_Products/create') ?>"><i class="fa fa-circle-o"></i> Add Products</a></li>
            <?php endif; ?>
      ...
      <li><a href="<?php echo base_url('../ims') ?>"><i class="glyphicon glyphicon-log-out"></i> <span>Go To Raw Stock Inventory</span></a></li>
