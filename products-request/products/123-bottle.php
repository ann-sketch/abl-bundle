...
$query = "SELECT * FROM products_request WHERE product = 'Adonko 123 (Bottle)' ORDER BY ID DESC";
...
if ($number_of_finished_products > $total_number_of_products_requested) {
    ...
    $product_deficiency = abs(get_qty($ims_products_connect, "Adonko 123 (Bottle)") - $total_number_of_products_requested);
}
