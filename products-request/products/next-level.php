...
$number_of_finished_products = get_qty($ims_products_connect, "Adonko Next Level");
$total_number_of_products_requested = mysqli_fetch_assoc(mysqli_query($procurement_connect, "SELECT SUM(qty) FROM products_request WHERE product = 'Adonko Next Level' AND is_approved = '0' ORDER BY ID DESC"))['SUM(qty)'];
                    ...
                    <div class="col-lg-2 col-md-12">
                        <div class="white-box analytics-info" style="display: flex; height: 85%;">
                            <ul class="list-inline two-part d-flex align-items-center justify-content-around mb-0 flex-wrap">
                                ...
                                <li style="margin-left: 0px;margin-top: -100px;">
                                    <span class="counter text-success">Next Level</span>
                                </li>
                            </ul>
                        </div>
                    </div>
