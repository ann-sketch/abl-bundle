...
$total_number_of_products_requested = mysqli_fetch_assoc(mysqli_query($procurement_connect, "SELECT SUM(qty) FROM products_request WHERE product = 'Adonko 123 (Roll)' AND is_approved = '0' ORDER BY ID DESC"))['SUM(qty)'];
